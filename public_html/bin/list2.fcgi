...
# test modification fcgi, Hedonil
# use lib '/data/project/newwebtest/perl5/lib/perl5';
# use lib '/data/project/newwebtest/perl5/lib/perl5/x86_64-linux-gnu-thread-multi';
 $Opts->{'use_fastcgi'} = 1;
 $Opts->{'max-requests'} = 1000;
# end test
...
<fieldset class="inner">
  ...
  <a class="info">
    Page namespace<span>The numeric namespace of the page. The main article 
  ...
  <a class="info">
    Quality<span>For example: FA-Class, FL-Class, A-Class, B-Class, 
Start-Class, Stub-Class, List-Class. Only one value can be specified. 
</span>
  </a>: <input type="text" value="$quality" name="quality"/><br/>
  <a class="info">
    Importance<span>For example: Top-Class, High-Class, Mid-Class, Low-Class. Only one value can be specified. </span>
  </a>: <input type="text" value="$importance" name="importance"/><br/>
  <a class="info">
    Score<span>A numerical score used to select articles for release 
versions. Typical values range from 0 to 3000. All pages with scores greater than or equal to <i>x</i> will  be displayed.
     </span>
...
Move your mouse over <a class="info">underlined terms<span>This is an example.</span></a> for additional information.
</div>
  <div class="submit">
