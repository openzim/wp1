...
class TestMakeWikiLink(unittest.TestCase):
    ...
    def test_creates_link(self):
        ...
        self.assertEqual(
            link["href"], "https://en.wikipedia.org/wiki/Foo_categories_by_importance"
        )
...
class TestTableCaching(BaseWpOneDbTest):
    ...
    def test_empty_cache(self, patched_table_data, patched_redis):
        ...
        redis_conn.setex.assert_called_once_with(
            b"Water", timedelta(days=1), value=expected_pkl
        )
...
class TestTableOutput(unittest.TestCase):
    ...
    data = {
        ...
        "data": {
            ...
            b"Category-Class": {b"Mid-Class": 1, b"NotA-Class": 95},
            b"Disambig-Class": {b"NotA-Class": 2},
            b"FA-Class": {b"Mid-Class": 7},
            b"File-Class": {b"NotA-Class": 10},
            b"GA-Class": {b"High-Class": 4, b"Low-Class": 4, b"Top-Class": 1},
            b"List-Class": {
                b"High-Class": 1,
                b"Low-Class": 2,
                b"Mid-Class": 1,
            ...
            b"Project-Class": {b"NotA-Class": 2},
            b"Redirect-Class": {b"Low-Class": 2, b"NotA-Class": 11},
            b"Start-Class": {
                b"High-Class": 42,
                b"Low-Class": 178,
                b"Mid-Class": 77,
            ...
            b"Template-Class": {b"NotA-Class": 10},
            b"Unassessed-Class": {b"Unknown-Class": 1},
            b"Assessed-Class": {
                b"Top-Class": 12,
                b"High-Class": 108,
                b"Mid-Class": 199,
        ...
        "total": 1030,
        "col_labels": {
            b"High-Class": "{{High-Class|category=Category:High-importance_Modern_philosophy_articles}}",
            b"Low-Class": "{{Low-Class|category=Category:Low-importance_Modern_philosophy_articles}}",
            b"Mid-Class": "{{Mid-Class|category=Category:Mid-importance_Modern_philosophy_articles}}",
            b"NotA-Class": "Other",
        ...
        "row_labels": {
            ...
            b"B-Class": "{{B-Class|category=Category:B-Class_Modern_philosophy_articles}}",
            b"C-Class": "{{C-Class|category=Category:C-Class_Modern_philosophy_articles}}",
            b"Category-Class": "{{Category-Class|category=Category:Category-Class_Modern_philosophy_articles}}",
            b"Disambig-Class": "{{Disambig-Class|category=Category:Disambig-Class_Modern_philosophy_articles}}",
            b"FA-Class": "{{FA-Class|category=Category:FA-Class_Modern_philosophy_articles}}",
            b"File-Class": "{{File-Class|category=Category:File-Class_Modern_philosophy_articles}}",
            b"GA-Class": "{{GA-Class|category=Category:GA-Class_Modern_philosophy_articles}}",
            b"List-Class": "{{List-Class|category=Category:List-Class_Modern_philosophy_articles}}",
            b"NotA-Class": " style=\"text-align: center;\" | '''Other'''",
            b"Project-Class": "{{Project-Class|category=Category:Project-Class_Modern_philosophy_articles}}",
            b"Redirect-Class": "{{Redirect-Class|category=Category:Redirect-Class_Modern_philosophy_articles}}",
            b"Start-Class": "{{Start-Class|category=Category:Start-Class_Modern_philosophy_articles}}",
            b"Stub-Class": "{{Stub-Class|category=Category:Stub-Class_Modern_philosophy_articles}}",
            b"Template-Class": "{{Template-Class|category=Category:Template-Class_Modern_philosophy_articles}}",
            b"Unassessed-Class": "{{Unassessed-Class|category=Category:Unassessed_Modern_philosophy_articles}}",
            b"Assessed-Class": "{{Assessed-Class}}",
        },
        "total_cols": 8,
    }
    ...
    expected_web = {
        ...
        "data": {
            ...
            "Category-Class": {"Mid-Class": 1, "NotA-Class": 95},
            "Disambig-Class": {"NotA-Class": 2},
            "FA-Class": {"Mid-Class": 7},
            "File-Class": {"NotA-Class": 10},
            "GA-Class": {"High-Class": 4, "Low-Class": 4, "Top-Class": 1},
            "List-Class": {
                "High-Class": 1,
                "Low-Class": 2,
                "Mid-Class": 1,
            ...
            "Project-Class": {"NotA-Class": 2},
            "Redirect-Class": {"Low-Class": 2, "NotA-Class": 11},
            "Start-Class": {
                "High-Class": 42,
                "Low-Class": 178,
                "Mid-Class": 77,
            ...
            "Template-Class": {"NotA-Class": 10},
            "Unassessed-Class": {"Unknown-Class": 1},
            "Assessed-Class": {
                "Top-Class": 12,
                "High-Class": 108,
                "Mid-Class": 199,
        ...
        "col_labels": {
            "High-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:High-importance_Modern_philosophy_articles",
                "text": "High",
            },
            "Low-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Low-importance_Modern_philosophy_articles",
                "text": "Low",
            },
            "Mid-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Mid-importance_Modern_philosophy_articles",
                "text": "Mid",
            },
            "NotA-Class": "Other",
            "Top-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Top-importance_Modern_philosophy_articles",
                "text": "Top",
            },
            "Unknown-Class": {
        ...
        "row_labels": {
            "A-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:A-Class_Modern_philosophy_articles",
                "text": "A",
            },
            "B-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:B-Class_Modern_philosophy_articles",
                "text": "B",
            },
            "C-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:C-Class_Modern_philosophy_articles",
                "text": "C",
            },
            "Category-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Category-Class_Modern_philosophy_articles",
                "text": "Category",
            },
            "Disambig-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Disambig-Class_Modern_philosophy_articles",
                "text": "Disambig",
            },
            "FA-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:FA-Class_Modern_philosophy_articles",
                "text": "FA",
            },
            "File-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:File-Class_Modern_philosophy_articles",
                "text": "File",
            },
            "GA-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:GA-Class_Modern_philosophy_articles",
                "text": "GA",
            },
            "List-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:List-Class_Modern_philosophy_articles",
                "text": "List",
            },
            "NotA-Class": "Other",
            "Project-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Project-Class_Modern_philosophy_articles",
                "text": "Project",
            },
            "Redirect-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Redirect-Class_Modern_philosophy_articles",
                "text": "Redirect",
            },
            "Start-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Start-Class_Modern_philosophy_articles",
                "text": "Start",
            },
            "Stub-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Stub-Class_Modern_philosophy_articles",
                "text": "Stub",
            },
            "Template-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Template-Class_Modern_philosophy_articles",
                "text": "Template",
            },
            "Unassessed-Class": {
                "href": "https://en.wikipedia.org/wiki/Category:Unassessed_Modern_philosophy_articles",
                "text": "Unassessed",
            },
    ...
    def test_create_wikicode(self):
        ...
        self.assertIn(
            ...
            "| Modern philosophy articles by quality and importance",
            actual,
        )
        self.assertIn(
