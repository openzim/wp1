...
class BuilderTest(BaseWpOneDbTest):
    ...
    def test_on_zim_file_status_poll_file_ready(
        self, mock_utcnow, mock_redis, mock_connect, mock_is_ready
    ):
    ...
    @patch(
        "wp1.logic.builder.utcnow", return_value=datetime.datetime(2023, 1, 1, 5, 5, 5)
    )
    @patch("wp1.logic.builder.zimfarm.is_zim_file_ready")
    @patch("wp1.logic.builder.wp10_connect")
    @patch("wp1.logic.builder.redis_connect")
    def test_on_zim_file_status_poll_expired(
        self, mock_redis, mock_connect, mock_is_ready, mock_utcnow
    ):
    ...
    @patch("wp1.logic.builder.wp10_connect")
    @patch("wp1.logic.builder.redis_connect")
    def test_on_zim_file_status_poll_failed(
        self, mock_redis, mock_connect, mock_is_ready
    ):
