...
class ZimSchedulesEmailConfirmationTest(BaseWpOneDbTest):
    ...
    def test_confirm_email_subscription_invalid_token(self):
        ...
        success = zim_schedules.confirm_email_subscription(
            self.wp10db, fake_token, b"test@example.com"
        )
    ...
    def test_has_email_been_confirmed_false_no_email(self):
        ...
        result = zim_schedules.has_email_been_confirmed(
            self.wp10db, b"nonexistent@example.com"
        )
    ...
    def test_has_email_been_confirmed_false_unconfirmed_email(self):
        ...
        self._insert_zim_schedule_directly(self.zim_schedule)
        result = zim_schedules.has_email_been_confirmed(
            self.wp10db, b"test@example.com"
        )
        self.assertFalse(result)
    ...
    def test_confirm_email_subscription_confirms_all_with_same_email(self):
        ...
        schedule1 = attr.evolve(
            self.zim_schedule, s_id=schedule1_id, s_email_confirmation_token=token1
        )
        schedule2 = attr.evolve(
            self.zim_schedule, s_id=schedule2_id, s_email_confirmation_token=token2
        )
        ...
        success = zim_schedules.confirm_email_subscription(
            self.wp10db, token1, b"test@example.com"
        )
        self.assertTrue(success)
