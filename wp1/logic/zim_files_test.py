...
class ZimTasksTest(BaseWpOneDbTest):
    ...
    def test_get_zim_file_with_null_fields(self):
        ...
        self.assertEqual(zim_file_data_with_nulls['z_selection_id'], result.z_selection_id)
        self.assertEqual(zim_file_data_with_nulls['z_zim_schedule_id'], result.z_zim_schedule_id)
    ...
    def test_get_zim_task_by_task_id(self):
        ...
        result = get_zim_task_by_task_id(self.wp10db, self.test_zim_task_data['z_task_id'])
        self.assertIsNotNone(result)
        self.assertIsInstance(result, ZimTask)
        self.assertEqual(result.z_task_id, self.test_zim_task_data['z_task_id'])
    ...
    def test_get_zim_task_by_task_id_with_null_fields(self):
        ...
        result = get_zim_task_by_task_id(self.wp10db, zim_file_data_with_nulls['z_task_id'])
        self.assertIsNotNone(result)
