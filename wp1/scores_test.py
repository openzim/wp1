...
class ScoresTest(BaseWpOneDbTest):
    ...
    def test_get_pageview_url(self, mock_datetime):
        ...
        self.assertEqual(
            ...
            "2024/2024-04/pageviews-202404-user.bz2",
            actual,
        )
    ...
    def test_get_pageview_url_prev(self, mock_datetime):
        ...
        self.assertEqual(
            "https://dumps.wikimedia.org/other/pageview_complete/monthly/"
            "2024/2024-03/pageviews-202403-user.bz2",
            actual,
        )
    ...
    def test_insert_temp_pageviews(self):
        scores.insert_temp_pageviews(self.wp10db, "en", "Statue_of_Liberty", 1234, 100)
    ...
    def test_insert_temp_pageviews_existing(self):
        ...
        scores.insert_temp_pageviews(self.wp10db, "en", "Statue_of_Liberty", 1234, 200)
