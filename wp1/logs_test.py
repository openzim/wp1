...
class LogsTest(BaseCombinedDbTest):
  ...
  articles = [
    ...
    # weird errors.
    (b'Test practices', b'Unknown-Class', b'Category-Class', b'NotA-Class', b'NotA-Class', 14),
    (b'Testing mechanics', b'NotA-Class', b'Category-Class', b'NotA-Class', b'NotA-Class', 14),
    ...
    (b'Important tests', b'NotA-Class', b'NotA-Class', b'Unknown-Class', b'Low-Class'),
    (b'Test main inheritance', b'NotA-Class', b'NotA-Class', b'NotA-Class', b'Low-Class'),
    ...
    (b'Operation of tests', b'B-Class', b'Unassessed-Class', b'Mid-Class', b'Unassessed-Class'),
    (b'Lesser-known tests', b'Stub-Class', b'Start-Class', b'Unknown-Class', b'Mid-Class'),
    ...
    for i, a in enumerate(self.articles):
      ...
      if len(a) >= 3:
        if a[1] is not None and a[2] is not None:
          l = Log(l_project=self.project, l_article=a[0], l_action=b'quality',
                  l_old=a[1], l_new=a[2], l_namespace=ns, l_timestamp=ts,
                  l_revision_timestamp=wiki_ts)
          logs.append(l)
      if len(a) == 5:
        l = Log(l_project=self.project, l_article=a[0], l_action=b'importance',
                l_old=a[2], l_new=a[3], l_namespace=ns, l_timestamp=ts,
                l_revision_timestamp=wiki_ts)
        logs.append(l)
    return logs
  ...
  def _move_logs(self):
    ...
    for i, m in enumerate(self.moves):
      ...
      l = Log(l_project=self.project, l_article=m[0], l_action=b'moved',
              l_old=None, l_new=None, l_namespace=0, l_timestamp=ts,
              l_revision_timestamp=wiki_ts)
      logs.append(l)
    return logs
  ...
  def _insert_moves(self):
    move_data = [(0, m[0], 0, m[1], self.wiki_timestamps[
      i % len(self.wiki_timestamps)]) for i, m in enumerate(self.moves)]
    with self.wp10db.cursor() as cursor:
      cursor.executemany('''
        INSERT INTO moves
  ...
  def test_get_logs(self):
    expected = [
      (b'Catholicism', 0, b'Test Baz Bang', b'moved', b'20181225112233', None, None, b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Test Foo Bar', b'moved', b'20181227130000', None, None, b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Testing in Copenhaven', b'moved', b'20181225112233', None, None, b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Tests', b'moved', b'20181226101010', None, None, b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Art of testing', b'importance', b'20181226101010', b'FA-Class', b'Mid-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Art of testing', b'quality', b'20181226101010', b'A-Class', b'FA-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Failures of tests', b'quality', b'20181226101010', b'C-Class', b'C-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'How to test', b'importance', b'20181227130000', b'C-Class', b'NotA-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'How to test', b'quality', b'20181227130000', b'Stub-Class', b'C-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Important tests', b'importance', b'20181225112233', b'NotA-Class', b'Unknown-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Important tests', b'quality', b'20181225112233', b'NotA-Class', b'NotA-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Lesser-known tests', b'importance', b'20181225112233', b'Start-Class', b'Unknown-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Lesser-known tests', b'quality', b'20181225112233', b'Stub-Class', b'Start-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Operation of tests', b'importance', b'20181227130000', b'Unassessed-Class', b'Mid-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Operation of tests', b'quality', b'20181227130000', b'B-Class', b'Unassessed-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Rules of testing', b'quality', b'20181227130000', b'B-Class', b'FA-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Test frameworks', b'quality', b'20181226101010', b'NotA-Class', b'FL-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Test main inheritance', b'importance', b'20181226101010', b'NotA-Class', b'NotA-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Test main inheritance', b'quality', b'20181226101010', b'NotA-Class', b'NotA-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Test other inheritance', b'quality', b'20181225112233', b'Unknown-Class', b'B-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 14, b'Test practices', b'quality', b'20181225112233', b'Unknown-Class', b'Category-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 0, b'Test results', b'importance', b'20181227130000', b'NotA-Class', b'Mid-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Test results', b'quality', b'20181227130000', b'GA-Class', b'NotA-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Test sub inheritance', b'quality', b'20181227130000', b'Unknown-Class', b'GA-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Testing best practices', b'quality', b'20181226101010', b'C-Class', b'B-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Testing figures', b'importance', b'20181227130000', b'A-Class', b'NotA-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Testing figures', b'quality', b'20181227130000', b'NotA-Class', b'A-Class', b'2018-12-27T08:00:00Z'),
      (b'Catholicism', 0, b'Testing history', b'quality', b'20181225112233', b'Unassessed-Class', b'FL-Class', b'2018-12-25T08:22:33Z'),
      (b'Catholicism', 14, b'Testing mechanics', b'quality', b'20181226101010', b'NotA-Class', b'Category-Class', b'2018-12-26T05:10:10Z'),
      (b'Catholicism', 0, b'Testing tools', b'quality', b'20181225112233', b'B-Class', b'NotA-Class', b'2018-12-25T08:22:33Z')
    ]
  ...
  def test_get_revid_nonexistant_page(self):
    actual = logs.get_revid(
      self.wikidb, b'Non-existant', 0, datetime(2018, 1, 1))
  ...
  def test_calculate_logs_to_update_values(self, patched_current_datetime):
    expected = [l for l in self._logs()
  ...
  def test_get_section_categories(self):
    expected = {
      ...
      'reassessed': set((
        ...
        b'Testing figures',
        b'Testing history')),
      'removed': set((b'Testing tools', b'Test main inheritance')),
      'renamed': set()
    }
  ...
  def test_get_section_data(self):
    expected = {
      'log_date': 'Dec 25, 2018',
      'moved_name': {b'Test Baz Bang': 'Test Baz',
                     b'Testing in Copenhaven': 'Testing in Copenhagen'},
      'name': {b'Important tests': 'Important tests',
      ...
      'revid': {b'Important tests': {'importance': 15000, 'quality': 15000},
      ...
      'talk': {b'Important tests': 'Talk:Important tests',
      ...
      'talk_revid': {b'Important tests': {'importance': None, 'quality': None},
                     b'Lesser-known tests': {
                       'importance': None, 'quality': None},
    ...
    test_logs = [l for l in self._logs()
            if l.l_revision_timestamp.startswith(b'2018-12-25')]
  ...
  def test_generate_log_edits(self):
    ...
    for num, s in dates:
      test_logs = [l for l in self._logs()
                  if l.l_revision_timestamp.startswith(s)]
      test_logs.extend(l for l in self._move_logs()
                    if l.l_revision_timestamp.startswith(s))
    ...
    self.assertTrue(actual[2].startswith('=== Dec 25, 2018 ==='))
  ...
  def test_upload_log_page_for_project(
      self, patched_api, patched_wp10, patched_wiki):
