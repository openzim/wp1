...
class Builder(AbstractBuilder):
    ...
    def build(self, content_type, **params):
        ...
        try:
            ...
            raise Wp1RetryableSelectionError("The request to Wikidata timed out") from e
        ...
        try:
            ...
            raise Wp1FatalSelectionError(
                f"Wikidata sent back a non-200 status code: {r.status_code}"
            ) from e
        ...
        try:
            ...
            raise Wp1FatalSelectionError(
                ...
                "by a timeout because the result set is too large."
            ) from None
