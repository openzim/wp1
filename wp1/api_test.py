...
class ApiTest(unittest.TestCase):
    ...
    def test_save_page_tries_login_on_none_site(
        self, patched_get_page, patched_login, patched_credentials
    ):
    ...
    def test_get_revision_id_present(self):
        ...
        actual = wp1.api.get_revision_id_by_timestamp(self.page, "2015-05-05T15:55:55Z")
