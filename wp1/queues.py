...
def enqueue_single_project(redis, project_name, manual=False):
    ...
    enqueue_project(
        project_name, update_q, upload_q, redis=redis, track_progress=manual
    )
...
def enqueue_custom_table(redis, custom_name):
    ...
    upload_q.enqueue(
        custom_tables.upload_custom_table_by_name,
        custom_name,
...
def enqueue_project(project_name, update_q, upload_q, redis=None, track_progress=False):
