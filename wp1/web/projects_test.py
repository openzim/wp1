...
class ProjectTest(BaseWebTestcase):
    USER = {
        ...
        "identity": {"username": "WP1_user", "sub": "1234"},
    }
    EXPECTED_CATEGORY_LINKS = {
        "A-Class": {
            "href": "https://en.wikipedia.org/wiki/Category:A-Class_Project_0_articles",
            "text": "A",
        },
        "Assessed-Class": "Assessed",
        "B-Class": {
            "href": "https://en.wikipedia.org/wiki/Category:B-Class_Project_0_articles",
            "text": "B",
        },
        "FA-Class": {
            "href": "https://en.wikipedia.org/wiki/Category:FA-Class_Project_0_articles",
            "text": "FA",
        },
        "High-Class": {
            "href": "https://en.wikipedia.org/wiki/Category:High-Class_Project_0_articles",
            "text": "High",
        },
        "Low-Class": {
                ...
                for importance in ("High-Class", "Low-Class"):
                    categories.add(
                        (
                            ...
                            importance,
                            importance,
                            "%s_Project_0_articles" % importance,
                            100,
                        )
                    )
                    ratings.append(
