...
class EmailsTest(BaseWpOneDbTest):
    ...
    def test_send_zim_ready_email(self, mock_jinja_env, mock_credentials, mock_post):
        ...
        self.assertEqual(
            call_args[0][0], "https://api.mailgun.net/v3/test.com/messages"
        )
        ...
        self.assertEqual(
            email_data["subject"], "Your ZIM File is Ready for Download - Test ZIM"
        )
    ...
    def test_respond_to_zim_task_completed_no_remaining_generations(
        ...
        respond_to_zim_task_completed(
            self.wp10db, self.zim_task, schedule_no_generations
        )
